...
class Movie(models.Model):
    ...
    boxoffice = models.CharField(max_length=100, default="Unknown")
    rotten_tomatoes_rating = models.CharField(max_length=20, null=True, blank=True, default="N/A")
    runtime = models.CharField(max_length=20, null=True, blank=True, default="N/A")
    active = models.BooleanField(default=False)
    trailer_url = models.URLField(max_length=455, null=True, blank=True)
